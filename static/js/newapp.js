function LoadImage_NavBar(id,image){
    ...
    document.getElementById("nav_img_" + id).insertBefore(x, child);
};
...
jQuery(document).ready(function () {
  ...
  (function ($) {
    ...
    function TagsInput(element, options) {
      ...
      this.$container = $('<div class="newapp-input-tag" style="box-shadow: 0 0 0 !important"></div>');
    ...
    TagsInput.prototype = {
      ...
      add: function(item, dontPushVal, options) {
        ...
        var $tag = $('<span  style="margin-left:2px;" class="badge badge-success ' + (itemTitle !== null ? ('" title="' + itemTitle) : '') + '">' + htmlEncode(itemText) + '<span data-role="remove"></span></span>');
        $tag.data('item', item);
        ...
        if (self.options.maxTags === self.itemsArray.length || self.items().toString().length === self.options.maxInputLength)
          self.$container.addClass('newapp-input-tag-max');
      ...
      remove: function(item, dontPushVal, options) {
        ...
        if (self.options.maxTags > self.itemsArray.length)
          self.$container.removeClass('newapp-input-tag-max');
